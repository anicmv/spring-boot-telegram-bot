 ...
 * @author anicmv
 * @date 2026/5/3 18:02
 * @description 抖音 inline 结果提供器。
 */
@BotInline(BotConstant.INLINE_ID_DOUYIN)
@Component
public class DouyinInlineQueryResultProvider implements InlineQueryResultProvider {
    ...
    public InlineQueryResult createResult(BotContext context) {
        ...
        return InlineQueryResultArticle.builder()
                .id(sortId())
                .title("抖音解析")
                .description(limit(prompt, 80))
                .inputMessageContent(InputTextMessageContent.builder().messageText("▎解 析 中...").build())
